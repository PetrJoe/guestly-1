  ...
  return (
    <div className="w-full max-w-md rounded-2xl border border-[var(--surface-border)] bg-[var(--surface-card)] p-8 shadow-xl">
      <div className="mb-6 text-center">
        <h1 className="text-2xl font-bold tracking-tight text-[var(--foreground)]">Organiser Sign In</h1>
        <p className="mt-2 text-sm text-[var(--foreground-muted)]">Access your organiser tools</p>
      </div>
      {error && (
      ...
      <p className="mt-6 text-center text-sm text-[var(--foreground-muted)]">
        New organiser?{" "}
        <Link href="/organiser-auth/register" className="font-medium text-primary-600 hover:text-primary-700">
          Create an account
        </Link>
      </p>
    </div>
