    ...
    <div className="mx-auto max-w-4xl">
      <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold tracking-tight text-neutral-900">Organiser Subscription</h1>
            <p className="mt-1 text-sm text-neutral-600">Choose a plan to unlock organiser features.</p>
          </div>
          <Link href="/dashboard">
        ...
        <div className="mt-6 rounded-xl border border-neutral-200 bg-neutral-50 p-4">
          ...
          <div className="mt-1 text-sm text-neutral-600">
            {active ? (
              ...
              "Inactive • Choose a plan to activate your organiser account"
            )}
          </div>
