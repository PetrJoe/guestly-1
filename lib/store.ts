...
const products: Product[] = [
  ...
  { id: "prod-5", eventId: "evt-2", name: "Music Fiesta Hoodie", description: "Heavyweight zip-up hoodie with back print.", price: 45, image: "🧥", category: "Apparel", stock: 50, sold: 28, sizes: ["S", "M", "L", "XL", "XXL", "XXXL"], active: true },
